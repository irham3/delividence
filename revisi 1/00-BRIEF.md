...
Dokumen ini adalah source of truth untuk eligibility dan positioning ScopeHandshake. Periksa kembali Rules/FAQ Devpost sebelum submit karena materi acara dapat berubah.
...
- **Gemini 3.5 atau lebih baru** — target implementasi `gemini-3.5-flash`; verifikasi ID dan availability pada hari integrasi.
...
ScopeHandshake mempertahankan konteks lintas giliran dan lintas sesi, menggabungkan kontribusi freelancer serta klien, lalu beradaptasi melalui preference memory yang dikonfirmasi pengguna. Nilai agentic-nya terlihat dari:
...
ScopeHandshake tidak mencoba menyelesaikan pembayaran atau sengketa. Produk ini membuat batas kerja dan bukti penerimaan lebih jelas sebelum konflik muncul.
...
> **ScopeHandshake is a two-party AI scope and acceptance protocol—not another proposal chatbot or freelance marketplace.**
